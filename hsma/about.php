...
<body>
    ...
    <div class="homepage">
        <img src="01.png" alt="about" class="about anim">
        <h2 class="abt1 anim">ABOUT US</h2>
        <h2 class="abt2 anim">ABOUT US</h2>
        <p class="desc">Home Satisfactions Builders, founded in 2021, aimed to grow in the construction and renovation industry. In its early days, the company expanded by delivering high-quality work, ensuring customer satisfaction, and building a reputation for reliability. Effective financial management, maintaining positive cash flow, and investing in marketing, especially through a strong online presence and social media, helped them reach more customers. As demand grew, they hired skilled workers to support their continued growth.
        </p>
    </div>
    ...
    <div class="wrapper">
        ...
        <h2>Login</h2>
        <form action="about.php" method="POST"> <!-- Change form action to homepage.php -->
                <div class="input-box">

...
<body>
    ...
    <div class="services">
            ...
            <div class="service-box first">
                <img src="first.png" alt="overall">
                <h2>Innovative Design & Build Solutions</h2>
                <p>
                We specialize in delivering innovative design and build projects that meet the unique needs of our clients. Our team is dedicated to transforming visions into reality, providing tailored solutions for every project, from concept to completion. 
                </p>
            </div>

            <!-- Second Box -->
            <div class="service-box second">
                <img src="second.png" alt="roof">
                <h2>Roofing Excellence</h2>
                <p>
                We offer top-tier roofing services, ensuring unmatched quality and long-lasting durability for your projects. Whether it's new construction, repair, or replacement, our expert team delivers dependable solutions tailored to your needs.
                </p>
            </div>

            <!-- Third Box -->
            <div class="service-box third">
                <img src="third.png" alt="team">
                <h2>Property Care Experts</h2>
                <p>
                Our team is highly experienced in repair and maintenance work, ensuring your property stays in excellent condition with every service we provide. Whether it's routine maintenance or urgent repairs, we are committed to delivering high-quality solutions tailored to your needs. 
                </p>
            </div>
        </div>
    ...
    <div class="wrapper">
        ...
        <h2>Login</h2>
        <form action="services.php" method="POST"> <!-- Change form action to homepage.php -->
                <div class="input-box">

 ...
 <div class="checkbox-group">
    <div class="column">
        <div class="category">
            ...
            <div class="options">
                <div>
                    <input type="radio" id="structural-option1" name="structural[]" value="Foundation Works">
                    <label for="structural-option1" title="(Pile Driving, Slab, Footing)">Foundation Works</label>
                </div>
                <div>
                    <input type="radio" id="structural-option2" name="structural[]" value="Reinforced Concrete">
                    <label for="structural-option2" title="(Beams, Columns, Slabs)">Reinforced Concrete</label>
                </div>
                <div>
                    <input type="radio" id="structural-option3" name="structural[]" value="Steel Work">
                    <label for="structural-option3" title="(Frame, Bracing, Reinforcement)">Steel Work</label>
                </div>
                <div>
                    <input type="radio" id="structural-option4" name="structural[]" value="Masonry Works">
                    <label for="structural-option4" title="(Brick/Block Walls, Stonework)">Masonry Works</label>
                </div>
                <div>
                    <input type="radio" id="structural-option5" name="structural[]" value="Earthworks">
                    <label for="structural-option5" title="(Excavation, Backfilling)">Earthworks</label>
                </div>
                <div>
                    <input type="radio" id="structural-option6" name="structural[]" value="Grouting and Injection Works">
                    <label for="structural-option6">Grouting and Injection Works</label>
                </div>
                <div>
                    <input type="radio" id="structural-option-others" name="structural[]" value="Others">
        ...
        <div class="category">
            ...
            <div class="options">
                <div>
                    <input type="radio" id="architectural-option1" name="architectural[]" value="Painting">
                    <label for="architectural-option1" title="(Interior & Exterior)">Painting</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option2" name="architectural[]" value="Interior Design">
                    <label for="architectural-option2" title="(Finishes, Furnishings, Layout)">Interior Design</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option3" name="architectural[]" value="Flooring">
                    <label for="architectural-option3" title="(Tiles, Wood, Carpet, etc.)">Flooring</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option4" name="architectural[]" value="Ceiling">
                    <label for="architectural-option4" title="(Suspended, Acoustic)">Ceiling</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option5" name="architectural[]" value="Wall Finishes">
                    <label for="architectural-option5" title="(Plaster, Paneling, etc.)">Wall Finishes</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option6" name="architectural[]" value="Doors & Windows">
                    <label for="architectural-option6" title="(Installation, Framing)">Doors & Windows</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option7" name="architectural[]" value="Partitions">
                    <label for="architectural-option7" title="(Drywall, Glass, etc.)">Partitions</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option8" name="architectural[]" value="Landscaping">
                    <label for="architectural-option8" title="(Exterior Design, Garden)">Landscaping</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option9" name="architectural[]" value="Signage">
                    <label for="architectural-option9" title="(Directional and Safety Signage)">Signage</label>
                </div>
                <div>
                    <input type="radio" id="architectural-option-others" name="architectural[]" value="Others">
        ...
        <div class="column">
            <div class="category">
                ...
                <div class="options">
                    <div>
                        <input type="radio" id="civil-option1" name="civil[]" value="Site Development">
                        <label for="civil-option1" title="(Grading, Drainage)">Site Development</label>
                    </div>
                    <div>
                        <input type="radio" id="civil-option2" name="civil[]" value="Roadworks">
                        <label for="civil-option2" title="(Paving, Curbs, Gutters)">Roadworks</label>
                    </div>
                    <div>
                        <input type="radio" id="civil-option3" name="civil[]" value="Earthworks">
                        <label for="civil-option3" title="(Excavation, Embankment)">Earthworks</label>
                    </div>
                    <div>
                        <input type="radio" id="civil-option4" name="civil[]" value="Stormwater Management">
                        <label for="civil-option4" title="(Sewers, Drainage)">Stormwater Management</label>
                    </div>
                    <div>
                        <input type="radio" id="civil-option5" name="civil[]" value="Retaining Walls">
                        <label for="civil-option5" title="(For slope stabilization)">Retaining Walls</label>
                    </div>
                    <div>
                        <input type="radio" id="civil-option6" name="civil[]" value="Fencing and Gate Installation">
                        <label for="civil-option6">Fencing and Gate Installation</label>
                    </div>
                    <div>
            <input type="radio" id="architectural-option-others" name="civil[]" value="Others">
            <label for="architectural-option-others">Others</label>
            <input type="text" id="others-input" name="others-input" placeholder="Please specify">
        </div>
                    <hr id="civ-mech">
            ...
            <div class="category">
                ...
                <div class="options">
                    <div>
                        <input type="radio" id="mechanical-option1" name="mechanical[]" value="HVAC">
                        <label for="mechanical-option1" title="(Heating, Ventilation, Air Conditioning)">HVAC</label>
                    </div>
                    <div>
                        <input type="radio" id="mechanical-option2" name="mechanical[]" value="Fire Protection Systems">
                        <label for="mechanical-option2" title="(Sprinklers, Fire Extinguishers)">Fire Protection Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="mechanical-option3" name="mechanical[]" value="Lifts/Elevators">
                        <label for="mechanical-option3" title="(Installation and Maintenance)">Lifts/Elevators</label>
                    </div>
                    <div>
                        <input type="radio" id="mechanical-option4" name="mechanical[]" value="Air-Handling Units">
                        <label for="mechanical-option4" title="(Ductwork, Vents)">Air-Handling Units</label>
                    </div>
                    <div>
                        <input type="radio" id="mechanical-option5" name="mechanical[]" value="Pumps and Motors">
                        <label for="mechanical-option5" title="(For water, HVAC systems)"> Pumps and Motors</label>
                    </div>
                    <div>
                        <input type="radio" id="mechanical-option6" name="mechanical[]" value="Chillers and Boilers">
                        <label for="mechanical-option6">Chillers and Boilers</label>
                    </div>
                    <div>
            <input type="radio" id="architectural-option-others" name="mechanical[]" value="Others">
            <label for="architectural-option-others">Others</label>
            <input type="text" id="others-input" name="others-input" placeholder="Please specify">
        </div>
                </div>
        ...
        <div class="column">
            <div class="category">
                ...
                <div class="options">
                    <div>
                        <input type="radio" id="electrical-option1" name="electrical[]" value="Power Supply Systems">
                        <label for="electrical-option1" title="(Transformers, Main Distribution Boards)">Power Supply Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="electrical-option2" name="electrical[]" value="Lighting Systems">
                        <label for="electrical-option2" title="(Indoor, Outdoor, Emergency Lighting)">Lighting Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="electrical-option3" name="electrical[]" value="Auxiliary Services">
                        <label for="electrical-option3" title="(Backup Generators, UPS, Batteries)">Auxiliary Services</label>
                    </div>
                    <div>
                        <input type="radio" id="electrical-option4" name="electrical[]" value="Wiring and Cabling">
                        <label for="electrical-option4" title="(Power, Data, Telecommunication)">Wiring and Cabling</label>
                    </div>
                    <div>
                        <input type="radio" id="electrical-option5" name="electrical[]" value="Earthing and Grounding Systems">
                        <label for="electrical-option5">Earthing and Grounding Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="electrical-option6" name="electrical[]" value="Security Systems">
                        <label for="electrical-option6" title="(CCTV, Alarms, Access Control)">Security Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="electrical-option7" name="electrical[]" value="Audio-Visual Systems">
                        <label for="electrical-option7" title="(Sound, Projection Equipment)">Audio-Visual Systems</label>
                    </div>
                    <div>
            <input type="radio" id="architectural-option-others" name="electrical[]" value="Others">
            <label for="architectural-option-others">Others</label>
            <input type="text" id="others-input" name="others-input" placeholder="Please specify">
        </div>
                    <hr id="elec-plum">
            ...
            <div class="category">
                ...
                <div class="options">
                    <div>
                        <input type="radio" id="plumbing-option1" name="plumbing[]" value="Water Supply Systems">
                        <label for="plumbing-option1" title="(Pipes, Pumps, Water Tanks)">Water Supply Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="plumbing-option2" name="plumbing[]plumbing[]" value="Drainage Systems">
                        <label for="plumbing-option2" title="(Sanitary, Stormwater)">Drainage Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="plumbing-option3" name="plumbing[]" value="Sewage Treatment">
                        <label for="plumbing-option3" title="(Wastewater, Septic Systems)">Sewage Treatment</label>
                    </div>
                    <div>
                        <input type="radio" id="plumbing-option4" name="plumbing[]" value="Gas Systems">
                        <label for="plumbing-option4" title="(Piping, Metering)">Gas Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="plumbing-option5" name="plumbing[]" value="Hot Water Systems">
                        <label for="plumbing-option5" title="(Heaters, Solar Systems)">Hot Water Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="plumbing-option6" name="plumbing[]" value="Water Filtrarion System">
                        <label for="plumbing-option6">Water Filtration Systems</label>
                    </div>
                    <div>
                        <input type="radio" id="plumbing-option7" name="plumbing[]" value="Fixture and Fittings">
                        <label for="plumbing-option7" title="(Toilets, Faucets, Showers)">Fixtures and Fittings</label>
                    </div>
                    <div>
            <input type="radio" id="architectural-option-others" name="plumbing[]" value="Others">
            <label for="architectural-option-others">Others</label>
            <input type="text" id="others-input" name="others-input" placeholder="Please specify">
        </div>
                </div>
...
<hr>
            ...
            <div class="form-group">
                ...
                <div>
                    ...
                    <label for="timeSpan" id="timeSpan">(2 years and 9 months)</label>

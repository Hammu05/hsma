    ...
    <div class="menu-bar">
        <div class="menu">
            <ul class="menu-links">
                ...
                <li class="nav-link">
                    <a href="client_tracking.php" class="tablinks">Quotation Status</a>
                </li>
                <li class="nav-link">
            ...
            <?php foreach ($projects as $project): ?>
                <article class="card__article">
                    ...
                    <div class="card__data">
                        ...
                        <a href="client_tracking.php?project_id=<?php echo htmlspecialchars($project['project_id']); ?>" class="card__button">
    View Project
</a>

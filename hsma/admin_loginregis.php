...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register_admin'])) {
    ...
    try {
        ...
        if ($stmt->num_rows > 0) {
            ...
            echo "<script>window.location.href = 'admin_loginregis.php';</script>";
            exit;
        }
    } catch (Exception $e) {
...
<head>
    ...
    <link rel="stylesheet" href="admin_loginregis.css">
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="form-box login">
            <h2>Login</h2>
            <form action="admin_loginregis.php" method="POST"> <!-- Change form action to homepage.php -->
                <div class="input-box">
        ...
        <div class="form-box register">
            <h2>Register</h2>
            <form action="admin_loginregis.php" method="POST">
    ...
    <script src="admin_loginregis.js"></script>
</body>
</html>